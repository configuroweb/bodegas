...
<div class="container-fluid">
	<form action="" id="pricing-form">
		...
		<div class="form-group">
			<label for="unit_id" class="control-label">Precio Bodega</label>
		...
		<div class="form-group row px-2">
			<label for="monthly" class="control-label col-md-4">Mensual</label>
		...
		<div class="form-group row px-2">
			<label for="quarterly" class="control-label col-md-4">Quincenal</label>
		...
		<div class="form-group row px-2">
			<label for="annually" class="control-label col-md-4">Anual</label>
	...
	$(document).ready(function(){
		$('#monthly,#quarterly,#annually').on('input keyup',function(){
			...
			if(!$.isNumeric($(this).val())){
				$(this).addClass('border-danger').after("<div class='text-danger amount_err_msg'>Ingresa un monto valido</div>")
			}
		})
