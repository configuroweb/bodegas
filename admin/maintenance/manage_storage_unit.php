...
<div class="container-fluid">
	<form action="" id="unit-form">
		...
		<div class="form-group">
			<label for="unit_number" class="control-label">Número de Bodega</label>
		...
		<div class="form-group">
			...
			<option value="0" <?php echo isset($status) && $status == 0 ? 'selected' : '' ?>>Disponible</option>
			<option value="1" <?php echo isset($status) && $status == 1 ? 'selected' : '' ?>>No disponible</option>
			<option value="2" <?php echo isset($status) && $status == 2 ? 'selected' : '' ?>>En mantenimiento</option>
			</select>
		</div>
