...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Lista de Bodegas</h3>
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("¿Estás segur@ de eliminar esta bodega de forma permanente?","delete_category",[$(this).attr('data-id')])
		})
		$('#create_new').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Agregar nueva bodega","maintenance/manage_storage_unit.php","mid-large")
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Agregar nueva bodega","maintenance/manage_storage_unit.php?id="+$(this).attr('data-id'),"mid-large")
		})
